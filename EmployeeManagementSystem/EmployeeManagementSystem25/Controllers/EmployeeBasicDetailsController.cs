...
namespace EmployeeManagementSystem25.Controllers
{
    ...
    public class EmployeeBasicDetailsController : ControllerBase
    {
        ...
        {
            var response = await _employeeBasicDetailsService.AddVisitorByMakePostRequest(visitor);
            return Ok(response);
        }
        ...
        {
            var response = await _employeeBasicDetailsService.GetVisitorByMakePostRequest();
            return Ok(response);
        }
    }
