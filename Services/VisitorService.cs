...
namespace WebApplication1.Services
{
    public class VisitorService : IVisitorService
    {
        ...
        public async Task<VisitorDTO> AddVisitor(VisitorDTO visitoModel)
        {
            ...
            visitor.Intialize(true, Credentials.VisitorDocumenttype = "Visitor", "Atul", "Atul");
            ...
            string message = $@"
                ...
                We have a new visitor registered at CentraLogic premises. Please find the details below:
